        ...
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">            
              ...
              Table Mahasiswa<br>
              <a class="btn btn-primary" href="/mahasiswa"> Kembali</a></br></br>               
              </header>
              
              <div class="panel-body">
              @foreach($mahasiswa as $m)
                <form class="form-horizontal " method="post" action="/mahasiswa/update">
                {{ csrf_field() }}  
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="jenis_kelamin" value="{{ $m->jenis_kelamin }}">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <button type="submit" class="btn btn-primary"><i class="icon_plus_alt2"></i> Simpan Perubahan</button>
                </form>
                @endforeach
            </section>
          </div>
