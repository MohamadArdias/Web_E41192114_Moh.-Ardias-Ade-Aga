        ...
        <ul class="nav pull-right top-menu">
          ...
          <li id="mail_notificatoin_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{ asset('nice/img/avatar-mini.jpg')}} "></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{ asset('nice/img/avatar-mini2.jpg')}} "></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{ asset('nice/img/avatar-mini3.jpg')}} "></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{ asset('nice/img/avatar-mini4.jpg')}} "></span>
                                    <span class="subject">
        ...
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">            
              ...
              Table Mahasiswa<br>
              <a class="btn btn-primary" href="/mahasiswa/tambah"><i class="icon_plus_alt2"></i> Tambah</a></br></br>               
              </header>
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    <th><i class="icon_profile"></i> Nama</th>
                    <th><i class="icon_calendar"></i> Umur</th>
                    <th><i class="icon_mail_alt"></i> NIM</th>
                    <th><i class="icon_mobile"></i> Jenis Kelamin</th>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">                        
                        <a class="btn btn-success" href="/mahasiswa/edit/{{ $m->nim }}"><i class="icon_pencil"></i></a>
                        <a class="btn btn-danger" href="/mahasiswa/hapus/{{ $m->nim }}"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
				          @endforeach
